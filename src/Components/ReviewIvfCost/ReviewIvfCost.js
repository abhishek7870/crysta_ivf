...
import "../Review City/ReviewCity.css";
import "../Review City/reviewCarouselCity.css";
import { SecondCarouselContextIvfCost } from "../../ReviewCarouselContextIvfCost";
import CarouselItemCity from "../Review City/carouselItemCity";
import { BsArrowLeft, BsArrowRight } from "react-icons/bs";
import $ from "jquery";
import fig1 from "../../images/Group 2369.png";
import fig2 from "../../images/Vector (5).png";

export default class ReviewIvfCost extends Component {
  componentDidMount() {
  ...
  static contextType = SecondCarouselContextIvfCost;
  constructor(props) {
    super(props);
      ...
      <section className="section section-review">
        <div className="ReviewMobileCity center">
          ...
          <span>
            <img
              src={fig2}
              className="cStar cFirst"
              style={{ width: 20.23, height: 19 }}
              alt=""
            />
          </span>
          <span>
        ...
        <div className="ReviewDesktopCity">
          ...
          <div className="review-carouselCity">
            <div className="header">
              ...
              >
                <h1>Our Patients Love Us</h1>
                <span style={{ marginTop: 50, marginLeft: 30 }}>
                  <img
                    src={fig2}
                    style={{ width: "29.27px", height: "27.5px" }}
                    alt=""
                  />
                </span>
                <span style={{ marginTop: 50, marginLeft: 10 }}>
                  <img
                    src={fig2}
                    style={{ width: "29.27px", height: "27.5px" }}
                    alt=""
            ...
            <div className="slides" style={{ overflowY: "hidden" }}>
