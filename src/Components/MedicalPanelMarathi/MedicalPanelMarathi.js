...
import "../MedicalPanelHindi/MedicalPanelHindi.css";
...
import CarouselItem from "./carouselItemMarathi";
import { BsArrowLeft, BsArrowRight } from "react-icons/bs";
import "../MedicalPanelHindi/desktopCarouselHindi.css";
    ...
    return (
      <section className="section section-medical-panel">
        <div className="MedicalMobileViewHindi">
          <h3 className="center">महाराष्ट्रातील IVF डॉक्टर</h3>
        ...
        <div className="MedicalDesktopViewHindi">
          ...
          <div className="medical-carouselCity">
            <div className="header">
              <h4>महाराष्ट्रातील आयव्हीएफ (IVF) डॉक्टर</h4>
          ...
          <div className="center bookFreeButton">
            ...
            फ्विनामूल्य IVF सल्लाहघेण्याबाबत नोंद करा 
            </button>
