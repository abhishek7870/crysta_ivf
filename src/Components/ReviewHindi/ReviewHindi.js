...
import "./ReviewHindi.css";
import "./reviewCarouselHindi.css";
...
import { SecondCarouselContextHindi } from "../../ReviewCarouselContextHindi";
import CarouselItem from "./carouselItemHindi";
import { BsArrowLeft, BsArrowRight } from "react-icons/bs";

export default class ReviewCity extends Component {
  static contextType = SecondCarouselContextHindi;
  state = {
    items: [
      {
        id: 1,
                ...
                <div className="col s12 one">
                  <div className="card ">
                    <div className="horizontal">
                      ...
                      <img src={MakkadPng} srcset={MakkadPng}  alt="भारत में आईवीएफ (IVF) का खर्चा" />
                    </picture>
                      </div>
                      <div className="card-stacked">
                        <div className="card-content">
                          <div className="row"></div>
                          <span className="card-title">मिस्टर एंड मिसेज मक्क्ड़ 
</span>
                    ...
                    <p>
                    इनफर्टिलिटी के साथ सालो बिताना परेशानी भरा और दर्दनाक था लेकिन Crysta IVF और इनफर्टिलिटी विशेषज्ञों की सर्वश्रेष्ठ टीम ने हमारे लिए इलाज को बेहद आसान और परेशानी रहित बना दिया।
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="card ">
                    <div className="horizontal">
                      ...
                      <source srcset={ManchandaPng} type="image/png" /> 
                       <img src={ManchandaPng} srcset={ManchandaPng}  alt="भारत में बेस्ट आईवीएफ (IVF) सेंटर" /> 
                    </picture>
                      </div>
                      <div className="card-stacked">
                        <div className="card-content">
...
बेस्ट आईवीएफ (IVF) ट्रीटमेंट के अलावा मैं सर्वश्रेष्ठ आईवीएफ (IVF) डॉक्टर और उनकी विशेषज्ञता और उनका  अपने पेशेंट्स के प्रति दया भावना से बोहोत खुश हूँ | यही कुछ विशेषग्यताये Crysta IVF को बेस्ट आईवीएफ (IVF) सेंटर बनाती हैं| 
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="col s12 one">
                  <div className="card ">
                    <div className="horizontal">
                      ...
                      <img src={SeemaPng} srcset={SeemaPng}  alt="भारत में बेस्ट आईवीएफ (IVF) सेंटर" />
                    </picture>
                      </div>
                      <div className="card-stacked">
                        <div className="card-content">
                        <div className="row"></div>
                          <span className="card-title">मिसेज सीमा तनेजा 
</span>
                    ...
                    <p>
                    लगातार दो बार आईवीएफ (IVF) फेलियर के बाद मेरी गर्भाधान की संभावना काफी कम थी। Crysta IVF ने मेरे जीवन को बदल दिया क्योंकि यहाँ मुझे सफल गर्भाधान और एक स्वस्थ बच्चे की डिलीवरी में मदद मिली।
                ...
                <div className="col s12 one">
                  <div className="card ">
                    <div className="horizontal">
                      ...
                      <img src={MongaPng} srcset={MongaPng}  alt="भारत में बेस्ट आईवीएफ (IVF) डॉक्टर" />
                    </picture>
                      </div>
                      <div className="card-stacked">
                        <div className="card-content">
                        <div className="row"></div>
                          <span className="card-title">मिसेज रचना मोंगा  
</span>
