        ...
        <section className="section-BannerNew">
          <Helmet>
            ...
            <meta
              name="description"
              content={`
              Get IVF treatment at best IVF centre in ${this.props.cityname} at affordable cost. Crysta IVF clinic is one of the pioneer chains of fertility clinics in ${this.props.cityname} that strives to provide high-standard treatments for male and female infertility with high success rates
          `}
            />
            <meta
              name="viewport"
            ...
            <meta
              name="keywords"
              content={`
              Best Fertility Centre, IVF Centre in ${this.props.cityname}, Infertility treatment in ${this.props.cityname}, fertility clinic in ${this.props.cityname}, IVF success rates in ${this.props.cityname}, best IVF doctors in ${this.props.cityname}, best IVF clinics in ${this.props.cityname}
      ...
      return (
        <section className="section-BannerNew">
          <Helmet>
            ...
            <meta
              name="keywords"
              content={`Best Fertility Centre, IVF Centre in ${this.props.cityname}, Infertility treatment in ${this.props.cityname}, fertility clinic in ${this.props.cityname}, IVF success rates in ${this.props.cityname}, best IVF doctors in ${this.props.cityname}, best IVF clinics in ${this.props.cityname}`}
            />
          </Helmet>
          <div
            className="BannerDesktopViewCity BannerDesktopIvfCost"
