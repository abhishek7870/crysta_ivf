    ...
    if (isMobile) {
        ...
        <section>
          ...
          <div className="section section-footer">
            <div className="FooterMobileView">
              {/* <div className="rightShapeMobile"></div> */}
              <div className="row">
                {/* <div className="orangeShapeFooter"></div> */}
                <div className="col s12 aboutCrystaCity ">
                  <h4 className="surrogacyFooHeader">About Crysta IVF</h4>
                  <p>
                ...
                <div className="col s12 hearFromUs">
                  <h4 className="">Book Free Surrogacy Consultation</h4>
      ...
      return (
        <section>
          ...
          <div className="section section-footer">
            <div className="FooterDesktopViewCity">
              <div className="row footerFirstRow">
                <div className="col m6">
                  <h4 className="FooterSurroHeading">
                    Book Free Surrogacy Consultation
                  </h4>
              ...
              <div className="slidelefttorighy" onClick={this.showModal}>
                Talk To Our Fertility Expert{" "}
                <img alt="Best IVF Centre" src={callIcon}></img>{" "}
                <span style={{ marginLeft: 5, fontSize: 18 }}>8938935353</span>
              </div>
