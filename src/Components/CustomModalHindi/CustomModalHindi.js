...
class CustomModalHindi extends Component {
  constructor(props) {
    super(props);
    this.state = {
      phone: "",
    ...
    return (
      <div className="commonModal abc">
        ...
        >
          ...
          >
            <h1>फ्री आईवीएफ (IVF) कंसल्टेशन बुक करें</h1>
            <form onSubmit={this.onSubmit}>
              ...
              <button className="btn myButton left">बुक करे </button>
            </form>
          ...
          >
            ...
            <div className="wrap"> <div className="YellowBorderShape"></div></div> 
              ...
              <div className="col m7">
                <h4 className="thankh4">शुक्रिया!</h4>
                <p className="thankp">
                हमने आपका सवाल प्राप्त कर लिया है, आपको जल्द ही हमारी फर्टिलिटी सहायता टीम  संपर्क करेगी   
                </p>
                <h1 className="thankh1">
                तत्काल प्रश्नों के लिए, आप हमें कॉल कर सकते हैं
                </h1>
        ...
        >
          ...
          >
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <button className="btn">बुक करे </button>
            </form>
          </div>
          <div
            className="modal-content"
          ...
          >
            ...
            <p>तत्काल प्रश्नों के लिए, आप हमें कॉल कर सकते हैं</p>
...
export default CustomModalHindi;
