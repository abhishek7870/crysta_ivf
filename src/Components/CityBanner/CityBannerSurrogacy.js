...
// import chainOneSurrogacy from "../../images/chainOne.png";
// import chainTwoSurrogacy from "../../images/chainTwo.png";
// import chainThreeSurrogacy from "../../images/chainThree.png";
...
import chainThreeSurrogacy from '../../images/surrslider-3.svg';
import './CityBannerSurrogacy.css';
      ...
      return (
        <section className="section-BannerNew">
          <Helmet>
            ...
            <meta name='description' content={`Get IVF treatment at best IVF centre in ${this.props.cityname} at affordable cost. Crysta IVF clinic is one of the pioneer chains of fertility clinics in ${this.props.cityname} that strives to provide high-standard treatments for male and female infertility with high success rates. `} />
            <meta name='keywords' content={`Best Fertility Centre, IVF Centre in Delhi, Infertility treatment in ${this.props.cityname}, fertility clinic in ${this.props.cityname}, IVF success rates in ${this.props.cityname}, best IVF doctors in ${this.props.cityname}, best IVF clinics in ${this.props.cityname}`} />
          </Helmet>
          <div className="BannerMobileViewCity surr">
            ...
            <div className="paddingDiv">
              <div className="row ">
                <h1 className="cityHeadingMobile">Surrogacy Treatment Care You Can Believe in </h1>
                <div className="slide-container">
        <Slide {...properties}>
          <div className="each-slide valign-wrapper">
            <div className="valign-wrapper">
            <div style={{ width: '37px' }} className="orangeSeparatorCity"></div>
            <h6>
            High  <span> Surrogacy Success Rates</span>
            </h6>
            </div>
            <div className="valign-wrapper">
            <div style={{ width: '37px' }} className="purpleSeparatorCity"></div>
            <h6>
            Transparent{" "}
          ...
          <div className="each-slide valign-wrapper">
            ...
            <div style={{ width: '37px' }} className="orangeSeparatorCity"></div>
            <h6>
            Dedicated <span> Fertility Counselling</span>
            </h6>
            </div>
            <div className="valign-wrapper">
            <div style={{ width: '45px' }} className="purpleSeparatorCity"></div>
                    <h6> Personalized <span>Treatment Care</span>
                    </h6>
            </div>
          </div>
        </Slide>
            ...
            <div className="banner-image">
              ...
              <div className="row banner-div">
                <h4>Get Free Surrogacy Consultation</h4>
          ...
          {/* <div id="modal6" class="modal ThankYouMpbile">
      ...
      return (
        <section className="section-BannerNew">
          ...
          <div className="BannerDesktopViewCity">
            ...
            <div className="navbar-fixed">
              <nav className="navbar active" style={{ background: this.state.background }}>
                <div className="nav-wrapper">
            ...
            <div className="row bannerContent">
              ...
              <div className="col m6">
                <h5>Surrogacy Treatment Care You Can Believe in </h5>

                <div className="bannerNumbers row surrogacybannerNumbers">
                  ...
                  <div className="valign-wrapper col m3 NumbersData">
                    <div style={{ width: '45px' }} className="orangeSeparatorCity"></div>
                    <h2> 
                    Dedicated <span> Fertility Counselling</span>
                    </h2>
                  </div>
                ...
                <div className="row">
                  <div className="greyDiv" style={{ height: '280px' }}>
                    <div className="row"></div>
                    <h2 className="surrogacyHeading">Book Free Surrogacy Consultation</h2>
                    <form onSubmit={this.onSubmit}>
                      <div className="row">
              ...
              <div className="col m6">
                ...
                <div className="video-container">
                  ...
                  <video className="landingMobVideo" width="100%" height="300" controls disablePictureInPicture controlsList="nodownload">
              ...
              <div className="col m12 bannerLastDiv">
                <h5>Services</h5>
                <div className="row bannerCards surrogacyServiceCards">
                  <div className="col m4">
                    <div className="card center">
                      <div className="card-image">
                        <div>
                        <img src={chainOneSurrogacy} alt="Surrogacy Programme" />
                        </div>
                      </div>
                      <div className="card-content">
                        <p>Surrogacy Programme</p>
                        <span>At Crysta IVF, we offer the intended parents full surrogacy programme at affordable prices.</span>
                      </div>
                    </div>
                  </div>
                  <div className="col m4">
                    <div className="card center">
                      <div className="card-image">
                        <img src={chainTwoSurrogacy} alt="Best IVF Centre" />
                      </div>
                      <div className="card-content">
                        <p>Donor IVF</p>
                        <span>We connect you with the suitable and well-matched egg or sperm donors to get positive outcomes   </span>
                      </div>
                    </div>
                  </div>
                  <div className="col m4">
                    <div className="card center">
                      <div className="card-image">
                        <img className="thirsSurroService" src={chainThreeSurrogacy} alt="Best IVF Centre" />
                      </div>
                      <div className="card-content">
                        <p>Surrogate Match</p>
                        <span>Crysta IVF helps you find well-screened surrogate matches for you as per your requirements.</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {/* <div id="modal5" class="modal ThankyouModalNew">
            <div class="modal-content">
